...
| 004 | neo4j-projection | integration | Given successful reasoning, can we project inferred class memberships and provenance to Neo4j as a read-model? Is the projection idempotent and queryable via Cypher? | **VALIDATED ✓** | integration, neo4j, projection |
