...
def run_spike():
    ...
    with onto:
        ...
        class MoralAgent(Entity):
            pass

        class MoralPatient(Entity):
            pass
    ...
    try:
        ...
        print(
            f"  Is Socrates inferred as MoralAgent? {'YES ✓' if is_moral_agent else 'NO ✗'}"
        )
    ...
    print(
        "  Assertion: 'Eating' is a PermittedAction AND it harms a MoralPatient (RestrictedAction)."
    )
